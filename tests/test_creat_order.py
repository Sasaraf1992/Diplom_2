...
class TestOrderCreation:
    ...
    def test_order_creation_with_auth(self, get_token):
        lu = LoginUser()
        co = CreateOrder()
    ...
    def test_order_creation_without_ingridients(self, get_token):
        co = CreateOrder()
        lu = LoginUser()
        lu.user_login(data=SD.FAKE_USER)
    ...
    def test_order_creation_with_wrong_hash(self, get_token):
        co = CreateOrder()
        lu = LoginUser()
        lu.user_login(data=SD.FAKE_USER)
